...
class _AcWidgetState extends State<AcWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AcModel());
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      await geminiTextFromImage(
                                        context,
                                        'when a user upload the image of the ac that can be either from a pcb of gthe ac or the capillary tubes or the fans or any image of the ac that can be wither a window ac or a split ac , you will have to find out by scannign the image or video if the part or ac is damaged and alsos tell which part is and share the reson of the part getting damaged and other affects of it ',
                                        uploadImageBytes:
                                            _model.uploadedLocalFile,
                                      ).then((generatedText) {
                                        safeSetState(
                                            () => _model.img = generatedText);
                                      });

                                      await geminiTextFromImage(
                                        context,
                                        'The image is of an ac inside or it can be outside analyse it and find problems in it. if in case you don;t find any state that we couldn;t recognize the image as of an AC . if it is detect problem and givev the final solutions based on the anayulaysis if you find any of the part or anything damaged or irregular. only give the solutions and suggestions and also with respect to the part and price. if the part price is very high then also give solutons to it and like more problems . ',
                                        uploadImageBytes:
                                            _model.uploadedLocalFile,
                                      ).then((generatedText) {
                                        safeSetState(() =>
                                            _model.solution = generatedText);
                                      });
