...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF63ACB0);
  late Color secondary = const Color(0xFF18AA99);
  late Color tertiary = const Color(0xFFCFF4F4);
  late Color alternate = const Color(0xFFEDE8DF);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0x00101518);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF33758C);
  late Color secondary = const Color(0xFF18AA99);
  late Color tertiary = const Color(0xFF002249);
  late Color alternate = const Color(0xFF1C262E);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF95A1AC);
  late Color primaryBackground = const Color(0xFF182026);
  late Color secondaryBackground = const Color(0xFF141819);
  ...
  late Color warning = const Color(0xFFF3C344);
  late Color error = const Color(0xFFC4454D);
  late Color info = const Color(0x00101518);
