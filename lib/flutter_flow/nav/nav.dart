...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => const Details04CoffeeProductWidget(),
        ),
        FFRoute(
          name: 'resuktyspage',
          path: '/resuktyspage',
          builder: (context, params) => const ResuktyspageWidget(),
        ),
        FFRoute(
          name: 'AC',
          path: '/AC',
          builder: (context, params) => const AcWidget(),
        ),
        FFRoute(
          name: 'TV',
          path: '/TV',
          builder: (context, params) => const TvWidget(),
        ),
        FFRoute(
          name: 'Fan',
          path: '/Fan',
          builder: (context, params) => const FanWidget(),
        ),
        FFRoute(
          name: 'Oven',
          path: '/Oven',
          builder: (context, params) => const OvenWidget(),
        )
