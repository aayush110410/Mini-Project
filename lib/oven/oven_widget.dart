...
import 'oven_model.dart';
export 'oven_model.dart';

class OvenWidget extends StatefulWidget {
  ...
  /// preiview it too.
  const OvenWidget({super.key});

  @override
  State<OvenWidget> createState() => _OvenWidgetState();
}

class _OvenWidgetState extends State<OvenWidget> {
  late OvenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OvenModel());
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    await geminiTextFromImage(
                                      context,
                                      'when a user upload the image of the Oven that can be either from a pcb of the a oven or the screen or the inside or any image or video of the oven that can be of any model or size or make  , you will have to find out by scanning the image or video if the part or oven  is damaged and alsos tell which part is and share the reson of the part getting damaged and other affects of it . give the exact price of the part in india ',
                                      uploadImageBytes:
                                          _model.uploadedLocalFile,
                                    ).then((generatedText) {
                                      safeSetState(
                                    ...
                                    await geminiTextFromImage(
                                      context,
                                      'The image is of an oven inside or it can be outside analyse it and find problems in it. if in case you don;t find any state that we couldn;t recognize the image or vide as of an oven . if it is detect problem and givev the final solutions based on the anayulaysis if you find any of the part or anything damaged or irregular. only give the solutions and suggestions and also with respect to the part and price. if the part price is very high then also give solutons to it and like more problems . ',
                                      uploadImageBytes:
                                          _model.uploadedLocalFile,
                                    ).then((generatedText) {
                                      safeSetState(() =>
